...
- 看提示阈值（无进展时引擎拉提示并加派新 agent 与你并行）：easy 15 分钟 / medium 30 分钟 / hard 40 分钟 / 多 flag 题 50 分钟
- 二次解题后仍无新 flag：单 flag 30 分钟、多 flag 40 分钟，引擎跳过该题
- 绝对兜底上限 = 看提示阈值 + 二次解题期限（easy 45 / medium 60 / hard 70 / 多 flag 90 分钟），到时强制终止
