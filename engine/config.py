...
class Config:
    def __init__(self, mock=False, t20=1200, t30=1800, t40=600,
                 poll=60, watcher_tick=5, slots=3, start_wait=120,
                 bb_dir=None, logs_dir=None, only=None, t20_easy=600,
                 t20_hard=1800, t20_multi=2400, t30_multi=2400):
        self.mock = mock
        ...
        self.t40 = t40                        # 绝对兜底 = 看提示 + 二次解题期限 + 600s 余量
